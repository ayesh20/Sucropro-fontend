...
export default function AdminLogin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.token) {
                ...
                localStorage.setItem('adminData', JSON.stringify(response.data.user || { email }));
    ...
    return (
        <div className="min-h-screen flex" style={{ background: "#f0fdf4" }}>
            ...
            >
                <div className="absolute -top-20 -left-20 w-72 h-72 rounded-full opacity-10 bg-green-400" />
                <div className="absolute bottom-10 -right-16 w-64 h-64 rounded-full opacity-10 bg-green-400" />
                <div className="absolute top-1/2 left-1/3 w-40 h-40 rounded-full opacity-5 bg-white" />
                ...
                <div className="flex items-center gap-3 relative z-10">
                    <div className="w-20 h-20 rounded-xl bg-white flex items-center justify-center overflow-hidden border border-white/20">
                        <img src="/images/logo.jpg" alt="Lanka Sugar" className="w-full h-full object-cover"
            ...
            <div className="flex-1 flex items-center justify-center p-6">
                <div className="w-full max-w-md">
                    ...
                    <div className="flex lg:hidden items-center gap-3 mb-8 justify-center">
                        <div className="w-10 h-10 rounded-xl bg-green-900 overflow-hidden">
                            <img src="/images/logo.jpg" alt="Lanka Sugar" className="w-full h-full object-cover"
                                onError={(e) => { e.target.style.display = 'none'; }} />
                        </div>
                        <div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 md:p-10">
                        <div className="mb-8">
                            <h1 className="text-2xl font-black text-gray-900 mb-1 tracking-tight">Welcome Admin</h1>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    type="email" id="email"
                                    placeholder="admin@lankasugar.lk"
                                    value={email}
